...
// GetProjectMembersActivityCounts returns active session counts and recent
...
func (r *Repo) GetProjectMembersActivityCounts(ctx context.Context, appID uuid.UUID, userIDs []uuid.UUID) (map[uuid.UUID]UserActivityCounts, error) {
