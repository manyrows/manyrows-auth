...
// PUT /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/webauthn-rpid
...
// GET /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/webauthn-rpid
...
// GET /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/passkeys
...
// DELETE /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/passkeys/{passkeyId}
