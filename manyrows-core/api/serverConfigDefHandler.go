...
// Product-scoped, like the catalog — no per-user gate.
...
// ServerCreateConfigKey defines a new config key in the product.
...
// ServerCreateFeatureFlag defines a new feature flag in the product.
