...
// app -> user.
// GET /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/identities
...
// DELETE /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/identities/{provider}
