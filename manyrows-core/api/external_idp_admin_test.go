...
func setupExternalIDPAdminRouter(t *testing.T) (*chi.Mux, *core.Workspace, *core.Project, uuid.UUID, core.TokenClaims) {
	t.Helper()
	svc := NewTestServices(t)
	r, wsRouter := NewAdminWorkspaceRouter(t, svc)
	base := "/projects/{projectId}/apps/{appId}/external-idps"
...
func extIDPBase(ws *core.Workspace, proj *core.Project, appID uuid.UUID) string {
	return "/admin/workspace/" + ws.ID.String() + "/projects/" + proj.ID.String() + "/apps/" + appID.String() + "/external-idps"
}
