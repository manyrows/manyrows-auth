...
// GET /admin/workspace/{workspaceId}/projects/{projectId}/configKeys
...
// POST /admin/workspace/{workspaceId}/projects/{projectId}/configKeys
func (handler *RequestHandler) HandleCreateConfigKey(w http.ResponseWriter, r *http.Request) {
	acc, _, project, ok := handler.adminAndProject(w, r)
	if !ok {
		return
	}
...
// GET /admin/workspace/{workspaceId}/projects/{projectId}/configKeys/{configKeyId}
...
// PATCH /admin/workspace/{workspaceId}/projects/{projectId}/configKeys/{configKeyId}
...
// DELETE /admin/workspace/{workspaceId}/projects/{projectId}/configKeys/{configKeyId}
...
// GET /admin/workspace/{workspaceId}/projects/{projectId}/configValues
func (handler *RequestHandler) HandleGetConfigValues(w http.ResponseWriter, r *http.Request) {
	...
	vals, err := handler.repo.GetConfigValuesByProjectID(r.Context(), project.ID)
	if err != nil {
...
// PUT /admin/workspace/{workspaceId}/projects/{projectId}/configKeys/{configKeyId}/apps/{appId}
...
// DELETE /admin/workspace/{workspaceId}/projects/{projectId}/configKeys/{configKeyId}/apps/{appId}
