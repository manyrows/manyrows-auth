...
func setupAppsRouter(t *testing.T) *chi.Mux {
	...
	wsRouter.Get("/products/{productId}/apps", svc.Handler.HandleGetApps)
	wsRouter.Post("/products/{productId}/apps", svc.Handler.HandleCreateApp)
	wsRouter.Get("/products/{productId}/apps/{appId}", svc.Handler.HandleGetApp)
	wsRouter.Put("/products/{productId}/apps/{appId}", svc.Handler.HandleUpdateApp)
	wsRouter.Delete("/products/{productId}/apps/{appId}", svc.Handler.HandleDeleteApp)
	wsRouter.Put("/products/{productId}/apps/{appId}/registration", svc.Handler.HandleUpdateAppRegistration)
	wsRouter.Put("/products/{productId}/apps/{appId}/auth-method-config", svc.Handler.HandleUpdateAppAuthMethodConfig)
	wsRouter.Put("/products/{productId}/apps/{appId}/google-config", svc.Handler.HandleUpdateAppGoogleConfig)
	wsRouter.Put("/products/{productId}/apps/{appId}/apple-config", svc.Handler.HandleUpdateAppAppleConfig)
	wsRouter.Put("/products/{productId}/apps/{appId}/microsoft-config", svc.Handler.HandleUpdateAppMicrosoftConfig)
	wsRouter.Put("/products/{productId}/apps/{appId}/github-config", svc.Handler.HandleUpdateAppGithubConfig)
...
func TestGetApps_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps", nil)
...
func TestCreateApp_Success(t *testing.T) {
	...
	defer func() {
		...
		_, _ = pool.Exec(context.Background(), "DELETE FROM apps WHERE product_id = $1", project.ID)
	}()
	...
	req := httptest.NewRequest(http.MethodPost, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps", bytes.NewReader(bodyBytes))
...
func TestGetApp_Success(t *testing.T) {
	...
	createReq := httptest.NewRequest(http.MethodPost, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps", bytes.NewReader(createBytes))
	...
	// Get it
	getReq := httptest.NewRequest(http.MethodGet, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID, nil)
...
func TestGetApp_NotFound(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+fakeID.String(), nil)
	testEnv.SetSessionCookie(t, req, claims)
...
func TestUpdateApp_Success(t *testing.T) {
	...
	updateReq := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID, bytes.NewReader(updateBytes))
...
func TestDeleteApp_Success(t *testing.T) {
	...
	// Delete it
	deleteReq := httptest.NewRequest(http.MethodDelete, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID, nil)
...
func TestCreateApp_NotMember(t *testing.T) {
	...
	fixtures := &TestFixtures{Account: owner, Workspace: ws, Products: []core.Product{*project}}
	defer testEnv.CleanupTestData(t, fixtures)
	defer func() {
		pool := testEnv.DB.Pool()
...
func TestUpdateAppRegistration_EnableWithRole(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/registration", bytes.NewReader(bodyBytes))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
...
func TestUpdateApp_ClearAppUrl(t *testing.T) {
	...
	setReq := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID, bytes.NewReader(setBytes))
	...
	clearReq := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID, bytes.NewReader(clearBytes))
...
func TestUpdateApp_SessionTtl_OmittedPreservesValue(t *testing.T) {
	...
	nameReq := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID, bytes.NewReader(nameBytes))
...
func TestUpdateAppAuthMethodConfig_Toggle(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/google-config", bytes.NewReader(enableGoogle))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
	rr := httptest.NewRecorder()
	router.ServeHTTP(rr, req)
	...
	req = httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/auth-method-config", bytes.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
...
func TestUpdateAppAuthMethodConfig_NoneRequiresOAuth(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/google-config", bytes.NewReader(disableGoogle))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
	rr := httptest.NewRecorder()
	router.ServeHTTP(rr, req)
...
func TestUpdateAppGoogleConfig_EnableSetClear(t *testing.T) {
	...
	url := "/admin/workspace/" + ws.ID.String() + "/products/" + project.ID.String() + "/apps/" + appID.String() + "/google-config"
...
func TestUpdateAppGoogleConfig_RejectsEnableWithoutClientID(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/google-config", bytes.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
...
func TestUpdateAppAppleConfig_EnableSetDisable(t *testing.T) {
	...
	url := "/admin/workspace/" + ws.ID.String() + "/products/" + project.ID.String() + "/apps/" + appID.String() + "/apple-config"
...
func TestUpdateAppAppleConfig_RejectsEnableWithoutFullCreds(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/apple-config", bytes.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
...
func TestUpdateAppMicrosoftConfig_EnableSetDisable(t *testing.T) {
	...
	url := "/admin/workspace/" + ws.ID.String() + "/products/" + project.ID.String() + "/apps/" + appID.String() + "/microsoft-config"
...
func TestUpdateAppMicrosoftConfig_RejectsEnableWithoutCreds(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/microsoft-config", bytes.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
...
func TestUpdateAppGithubConfig_EnableSetDisable(t *testing.T) {
	...
	url := "/admin/workspace/" + ws.ID.String() + "/products/" + project.ID.String() + "/apps/" + appID.String() + "/github-config"
...
func TestUpdateAppGithubConfig_RejectsEnableWithoutCreds(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/github-config", bytes.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
