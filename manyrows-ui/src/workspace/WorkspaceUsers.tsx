...
type AppRef = { id: string; name: string; projectId: string };
                        ...
                        {u.apps.length > 0 ? (
                          u.apps.map((a) => (
                            <Chip
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                navigate(`/app/workspace/${workspace.id}/projects/${a.projectId}/apps/${a.id}/members?email=${encodeURIComponent(u.email)}`);
                              }}
                      ...
                      selectedUser.apps.map((a) => (
                        <Chip
                          ...
                          onClick={() => {
                            ...
                            setSelectedUser(null);
                            navigate(`/app/workspace/${workspace.id}/projects/${a.projectId}/apps/${a.id}/members?email=${encodeURIComponent(email)}`);
                          }}
                          sx={{ height: 20, fontSize: 11 }}
                        />
                      ))
