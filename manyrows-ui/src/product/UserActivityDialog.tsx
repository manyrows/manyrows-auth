...
export default function UserActivityDialog({
  ...
  React.useEffect(() => {
    ...
    const url = `/admin/workspace/${workspaceId}/products/${productId}/apps/${appId}/users/${userId}/activity`;
    axios
  ...
  }, [open, workspaceId, productId, appId, userId]);
  ...
  const passkeysURL = `/admin/workspace/${workspaceId}/products/${productId}/apps/${appId}/users/${userId}/passkeys`;
  ...
  const identitiesURL = `/admin/workspace/${workspaceId}/products/${productId}/apps/${appId}/users/${userId}/identities`;
