...
import type { Permission, Project, Workspace } from "../core.ts";
...
// /admin/workspace/{workspaceId}/projects/{projectId}/permissions
...
async function deletePermission(project: Project, permissionId: string): Promise<void> {
