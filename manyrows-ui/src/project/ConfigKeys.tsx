...
import type { ConfigExposure, ConfigKey, ConfigValue, ConfigValueType, App, Project, Workspace } from "../core.ts";
...
function ConfigKeysAbout(props: { secretReady: boolean; expanded: boolean; onToggle: () => void; t: TFunc }) {
  ...
  return (
    <Box>
      ...
      >
        <Box component="span" sx={{ display: "inline-flex", flexShrink: 0, color: "text.disabled", mt: "1px" }}>
