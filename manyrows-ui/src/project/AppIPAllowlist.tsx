...
export default function AppIPAllowlist({ workspaceId, projectId, appId, open = true, onClose, inline }: Props) {
  const { t } = useTranslation();
  const basePath = `/admin/workspace/${workspaceId}/projects/${projectId}/apps/${appId}/ipAllowlist`;
