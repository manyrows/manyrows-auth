...
import type { Project, Permission, Role, Workspace } from "../core.ts";
...
function rolesBase(project: Project) {
  return `/admin/workspace/${project.workspaceId}/projects/${project.id}/roles`;
}

function permissionsBase(project: Project) {
...
async function createRole(project: Project, body: Pick<Role, "name" | "slug">): Promise<Role> {
...
async function deleteRole(project: Project, roleId: string): Promise<void> {
  // Requires backend endpoint:
  // DELETE /admin/workspace/{workspaceId}/projects/{projectId}/roles/{roleId}
...
async function patchRolePermissions(project: Project, roleId: string, permissionIds: string[]): Promise<void> {
