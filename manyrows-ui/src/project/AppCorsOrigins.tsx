...
export default function AppCorsOrigins({ workspaceId, projectId, appId, open = true, onClose, inline }: Props) {
  const { t } = useTranslation();
  const basePath = `/admin/workspace/${workspaceId}/projects/${projectId}/apps/${appId}/corsOrigins`;
